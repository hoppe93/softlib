...
class SOFTDistributionFunction : public NumericDistributionFunction {
    public:
        SOFTDistributionFunction(const std::string&, bool logarithmic=true, int interptype=NumericDistributionFunction::INTERPOLATION_CUBIC);

        void Load(const std::string&, bool logarithmic=true, int interptype=NumericDistributionFunction::INTERPOLATION_CUBIC);
        static struct softdf_data* __Load(const std::string&);
        static NumericMomentumSpaceDistributionFunction *LoadMomentumSpace(
            const std::string&, bool logarithmic=true, unsigned int radindex=0,
