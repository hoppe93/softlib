/**
 * WARNING: This class is deprecated and may be removed in
 * future versions of softlib! Please use the new 'SOFTDistributionFunction'
 * class instead.
 *
 * Implementation of the (old) SOFT Distribution Function
...
#include <softlib/DistributionFunction/deprSOFTDistributionFunction.h>
...
deprSOFTDistributionFunction::deprSOFTDistributionFunction(const string &fname, MagneticField2D*, bool logarithmic, int interptype) {
 ...
 */
void deprSOFTDistributionFunction::Load(const string& fname, bool logarithmic, int interptype) {
    struct deprsoftdf_data *dat;
    dat = deprSOFTDistributionFunction::__Load(fname, nullptr);
...
*deprSOFTDistributionFunction::LoadMomentumSpace(
 ...
 */
struct deprsoftdf_data *deprSOFTDistributionFunction::__Load(const string &fname, MagneticField2D*) {
    string punits;
    sfilesize_t fsize[2];
    slibreal_t normf;
    ...
    dat     = new struct deprsoftdf_data;
    dat->nr  = nnr;
    dat->np  = nnp;
    dat->nxi = nnxi;
 ...
 */
bool deprSOFTDistributionFunction::Verify(const string& var, double **v, sfilesize_t n, sfilesize_t step, SFile *sf) {
